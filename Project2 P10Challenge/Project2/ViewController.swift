...
class ViewController: UIViewController {
    ...
    func showFinalScore() {
        ...
        if score > highestScore {
            specialMessage = "You've broken previous higest score \(highestScore)"
            UserDefaults.standard.set(score, forKey: "highestScore")
        }
        let ac = UIAlertController(title: "Game Over", message: "Your final score is \(score)!\(specialMessage)", preferredStyle: .alert)
